...
export const TranslationResultSection = ({
  ...
  return (
    <article className="translation-result relative w-full rotate-[0.6deg]">
      <span
        aria-hidden="true"
        ...
        <header className="flex flex-col gap-1 border-b border-dashed border-amber-300 pb-4">
          ...
          {result.url && (
            <a
              ...
              className="font-doc-aux truncate text-xs text-indigo-600 underline underline-offset-2"
            >
              {result.url}
            </a>
          )}
