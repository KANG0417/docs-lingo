import { normalizeTranslationListMarkers } from "@/lib/translation/markup/translation-list-line-utils";
import { repairGluedTranslationSections } from "@/lib/translation/markup/translation-section-layout";
...
export const normalizeTranslatedLayout = (content: string): string => {
  ...
  normalizedContent = normalizeTranslationListMarkers(normalizedContent);
  normalizedContent = repairGluedTranslationSections(normalizedContent);
